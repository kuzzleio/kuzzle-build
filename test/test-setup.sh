...
sh -c "docker run -d -e SETUPSH_SHOW_DEBUG -e COMPOSE_HTTP_TIMEOUT -e DOCKER_CLIENT_TIMEOUT -e CONNECT_TO_KUZZLE_WAIT_TIME_BETWEEN_RETRY --privileged --rm --name $CONTAINER_NAME -v $PWD:/opt $IMAGE_NAME $OUTPUT"
EXIT_VALUE=$?
